...
class _$_Weather implements _Weather {
  ...
  @override
  @JsonKey(name: 'weather')
  List<WeatherDetail>? get weatherDetails {
    final value = _weatherDetails;
...
abstract class _Main implements Main {
  const factory _Main(
      ...
      @JsonKey(name: 'grnd_level') final int? grndLevel}) = _$_Main;
...
abstract class _Rain implements Rain {
  const factory _Rain({final double? the1H}) = _$_Rain;
...
/// @nodoc
@JsonSerializable()
class _$_WeatherDetail implements _WeatherDetail {
